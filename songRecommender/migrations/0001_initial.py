# Generated by Django 2.0.7 on 2018-10-15 12:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('distance_to_other_songs', models.ManyToManyField(related_name='songs_nearby', through='songRecommender.Distance', to='songRecommender.Song')),
            ],
        ),
        migrations.CreateModel(
            name='Song_in_List',
        ...
        migrations.AddField(
            model_name='profile',
            name='nearby_songs',
            field=models.ManyToManyField(related_name='Songs_close_to_user', through='songRecommender.Distance_to_User', to='songRecommender.Song'),
        ),
        migrations.AddField(
            model_name='profile',
            name='played_songs',
            field=models.ManyToManyField(related_name='Songs_played_by_user', through='songRecommender.Played_Song', to='songRecommender.Song'),
        ),
        migrations.AddField(
            model_name='profile',
            name='user',
        ...
        migrations.AddField(
            model_name='played_song',
            name='user_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='songRecommender.Profile'),
        ),
        migrations.AddField(
            model_name='list',
            name='nearby_songs',
        ...
        migrations.AddField(
            model_name='distance_to_user',
            name='user_id',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='songRecommender.Profile'),
        ),
        migrations.AddField(
